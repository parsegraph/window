...
export default class ProxyComponent extends Component {
  ...
  render(width: number, height: number, avoidIfPossible?: boolean) {
  ...
  contextChanged(isLost: boolean) {
    ...
    return this._contextChangedFunc.call(
      this._contextChangedFuncThisArg,
      isLost
    );
  }
  ...
  setPainter(painterFunc: Function, painterFuncThisArg?: object) {
    this._painterFunc = painterFunc;
    this._painterFuncThisArg = painterFuncThisArg;
  }

  setRenderer(rendererFunc: Function, rendererFuncThisArg?: object) {
    this._rendererFunc = rendererFunc;
    this._rendererFuncThisArg = rendererFuncThisArg;
  }

  setContextChanged(contextChanged: Function, contextChangedThisArg?: object) {
    this._contextChangedFunc = contextChanged;
    this._contextChangedFuncThisArg = contextChangedThisArg;
  }

  setSerializer(serializerFunc: Function, serializerFuncThisArg?: object) {
