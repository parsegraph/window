...
app.get('/', async (req, res) => {
  ...
  write(`</head>`);
  write(`<body>`);
  write(`<h1>window <a href='/coverage'>Coverage</a> <a href='/docs'>Docs</a></h1>`);
  write(`<p>This library is available as JavaScript UMD module: <a href='/window.js'>window.js</a></p>`);
